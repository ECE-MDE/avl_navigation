...
#ifndef SINS_MUKF_OLD_H
#define SINS_MUKF_OLD_H
...
class SinsMukfOld : public NavFilter
{
...
public:
    ...
    // Returns:     ???.
    //--------------------------------------------------------------------------
    static NavStateOld phi_func(NavStateOld x, VectorXd xi);
    ...
    // Returns:     ???.
    //--------------------------------------------------------------------------
    static VectorXd phi_inv_func(NavStateOld x, NavStateOld x_hat);
    ...
    // Returns:     New state.
    //--------------------------------------------------------------------------
    static NavStateOld f_func(NavStateOld x, NavInput omega, VectorXd w);
    ...
    //--------------------------------------------------------------------------
    static VectorXd h_func_pos(NavStateOld x, Vector3d l_bS_b);
    ...
    //              state.
    //--------------------------------------------------------------------------
    static VectorXd h_func_vel(NavStateOld x, Vector3d l_bS_b, Vector3d w_ib_b);
    ...
    //--------------------------------------------------------------------------
    static VectorXd h_func_depth(NavStateOld x, double alt_surface, Vector3d l_bS_b);
    ...
    //--------------------------------------------------------------------------
    static VectorXd h_func_range(NavStateOld x, Vector3d p_source, Vector3d l_bS_b);
    ...
    // Returns:     Position measurement corresponding to current state.
    //--------------------------------------------------------------------------
    static VectorXd h_func_gps(NavStateOld x, Vector3d l_bS_b, Vector3d w_ib_b);

private:

    // MUKF instance
    Mukf<NavStateOld, NavInput> mukf;
