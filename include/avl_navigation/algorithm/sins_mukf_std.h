...
class SinsMukfStd : public NavFilter
{
...
public:
    ...
    // Returns:     ???.
    //--------------------------------------------------------------------------
    static NavStateStd phi_func(NavStateStd x, VectorXd xi);
    ...
    // Returns:     ???.
    //--------------------------------------------------------------------------
    static VectorXd phi_inv_func(NavStateStd x, NavStateStd x_hat);
    ...
    // Returns:     New state.
    //--------------------------------------------------------------------------
    static NavStateStd f_func(NavStateStd x, NavInput omega, VectorXd w);
    ...
    //--------------------------------------------------------------------------
    static VectorXd h_func_pos(NavStateStd x, Vector3d l_bS_b);
    ...
    //              state.
    //--------------------------------------------------------------------------
    static VectorXd h_func_vel(NavStateStd x, Vector3d l_bS_b, Vector3d w_ib_b);
    ...
    //--------------------------------------------------------------------------
    static VectorXd h_func_depth(NavStateStd x, double alt_surface, Vector3d l_bS_b);
    ...
    //--------------------------------------------------------------------------
    static VectorXd h_func_range(NavStateStd x, Vector3d p_source, Vector3d l_bS_b);
    ...
    // Returns:     Position measurement corresponding to current state.
    //--------------------------------------------------------------------------
    static VectorXd h_func_gps(NavStateStd x, Vector3d l_bS_b, Vector3d w_ib_b);

private:

    // MUKF instance
    Mukf<NavStateStd, NavInput> mukf;
