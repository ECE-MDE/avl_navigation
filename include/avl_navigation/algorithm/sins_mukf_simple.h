...
#ifndef SINS_MUKF_SIMPLE_H
#define SINS_MUKF_SIMPLE_H
...
class SinsMukfSimple : public NavFilter
{
...
public:
    ...
    // Returns:     ???.
    //--------------------------------------------------------------------------
    static NavStateSimple phi_func(NavStateSimple x, VectorXd xi);
    ...
    // Returns:     ???.
    //--------------------------------------------------------------------------
    static VectorXd phi_inv_func(NavStateSimple x, NavStateSimple x_hat);
    ...
    // Returns:     New state.
    //--------------------------------------------------------------------------
    static NavStateSimple f_func(NavStateSimple x, NavInputSimple omega, VectorXd w);
    ...
    //--------------------------------------------------------------------------
    static VectorXd h_func_pos(NavStateSimple x, Vector3d l_bS_b);
    ...
    //              state.
    //--------------------------------------------------------------------------
    static VectorXd h_func_vel(NavStateSimple x);
    ...
    //--------------------------------------------------------------------------
    static VectorXd h_func_depth(NavStateSimple x, double alt_surface);
    ...
    //--------------------------------------------------------------------------
    static VectorXd h_func_range(NavStateSimple x, Vector3d p_source);
    ...
    // Returns:     Position measurement corresponding to current state.
    //--------------------------------------------------------------------------
    static VectorXd h_func_gps(NavStateSimple x);

private:

    // MUKF instance
    Mukf<NavStateSimple, NavInputSimple> mukf;
