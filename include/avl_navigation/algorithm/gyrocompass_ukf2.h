...
#ifndef GYROCOMPASS_UKF2_H
#define GYROCOMPASS_UKF2_H
...
public:
    ...
    // Returns:     New state.
    //--------------------------------------------------------------------------
    static VectorXd f_func(VectorXd x, VectorXd w);
...
private:
    ...
    Matrix3d C_n_n0 = Matrix3d::Identity();
    Matrix3d C_n_b = Matrix3d::Identity();
    Vector3d g_b_n;

};

#endif // GYROCOMPASS_UKF2_H
