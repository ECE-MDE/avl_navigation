...
#ifndef SINS_MUKF_STD_H
#define SINS_MUKF_STD_H
...
class SinsMukfScaled : public NavFilter
{
...
public:
    ...
    // Returns:     ???.
    //--------------------------------------------------------------------------
    static NavStateScaled phi_func(NavStateScaled x, VectorXd xi);
    ...
    // Returns:     ???.
    //--------------------------------------------------------------------------
    static VectorXd phi_inv_func(NavStateScaled x, NavStateScaled x_hat);
    ...
    // Returns:     New state.
    //--------------------------------------------------------------------------
    static NavStateScaled f_func(NavStateScaled x, NavInputScaled omega, VectorXd w);
    ...
    //--------------------------------------------------------------------------
    static VectorXd h_func_pos(NavStateScaled x, Vector3d l_bS_b);
    ...
    //              state.
    //--------------------------------------------------------------------------
    static VectorXd h_func_vel(NavStateScaled x, Vector3d l_bS_b, Vector3d w_ib_b);
    ...
    //--------------------------------------------------------------------------
    static VectorXd h_func_depth(NavStateScaled x, double alt_surface, Vector3d l_bS_b);
    ...
    //--------------------------------------------------------------------------
    static VectorXd h_func_range(NavStateScaled x, Vector3d p_source, Vector3d l_bS_b);
    ...
    // Returns:     Position measurement corresponding to current state.
    //--------------------------------------------------------------------------
    static VectorXd h_func_gps(NavStateScaled x, Vector3d l_bS_b, Vector3d w_ib_b);

private:

    // MUKF instance
    Mukf<NavStateScaled, NavInputScaled> mukf;
