...
//------------------------------------------------------------------------------
// Name:        SinsMukfOld constructor
//------------------------------------------------------------------------------
SinsMukfOld::SinsMukfOld()
{

}

//------------------------------------------------------------------------------
// Name:        SinsMukfOld destructor
//------------------------------------------------------------------------------
SinsMukfOld::~SinsMukfOld()
{
...
//------------------------------------------------------------------------------
void SinsMukfOld::init(VectorXd x0, MatrixXd P0, MatrixXd Q)
{
...
//------------------------------------------------------------------------------
void SinsMukfOld::iterate(Vector3d w_ib_b, Vector3d f_ib_b, double dt)
{
...
//------------------------------------------------------------------------------
MeasInfo SinsMukfOld::process_body_velocity(Vector3d v_eb_b_meas, Vector3d w_ib_b,
...
// Returns:     Measurement info struct.
//------------------------------------------------------------------------------
MeasInfo SinsMukfOld::process_depth(VectorXd depth_meas, double alt_surface,
    MatrixXd R, VectorXd threshold, Vector3d l_bS_b)
{
...
// Returns:     Measurement info struct.
//------------------------------------------------------------------------------
MeasInfo SinsMukfOld::process_range(VectorXd range_meas, Vector3d p_source,
    MatrixXd R, VectorXd threshold, Vector3d l_bS_b)
{
...
// Returns:     Measurement info struct.
//------------------------------------------------------------------------------
MeasInfo SinsMukfOld::process_position(Vector3d p_b_meas,
    MatrixXd R, VectorXd threshold, Vector3d l_bS_b)
{
...
// Returns:     Measurement info struct.
//------------------------------------------------------------------------------
MeasInfo SinsMukfOld::process_gps(VectorXd gps_meas, Vector3d w_ib_b,
    MatrixXd R, VectorXd threshold, Vector3d l_bS_b)
{
...
//------------------------------------------------------------------------------
VectorXd SinsMukfOld::get_state()
{
...
// Returns:     ???.
//------------------------------------------------------------------------------
NavStateOld SinsMukfOld::phi_func(NavStateOld x, VectorXd xi)
{
...
// Returns:     ???.
//------------------------------------------------------------------------------
VectorXd SinsMukfOld::phi_inv_func(NavStateOld x, NavStateOld x_hat)
{
    VectorXd xi(15);
...
// Returns:     New state.
//------------------------------------------------------------------------------
NavStateOld SinsMukfOld::f_func(NavStateOld x, NavInput omega, VectorXd w)
{
    omega.w_ib_b += -x.b_g + w.segment(0,3) + w.segment(6,3);
    omega.f_ib_b += -x.b_a + w.segment(3,3) + w.segment(9,3);
...
//------------------------------------------------------------------------------
VectorXd SinsMukfOld::h_func_pos(NavStateOld x, Vector3d l_bS_b)
{
...
//              state.
//------------------------------------------------------------------------------
VectorXd SinsMukfOld::h_func_vel(NavStateOld x, Vector3d l_bS_b, Vector3d w_ib_b)
{
...
//------------------------------------------------------------------------------
VectorXd SinsMukfOld::h_func_depth(NavStateOld x, double alt_surface, Vector3d l_bS_b)
{
...
//------------------------------------------------------------------------------
VectorXd SinsMukfOld::h_func_range(NavStateOld x, Vector3d p_source, Vector3d l_bS_b)
{
...
// Returns:     Position measurement corresponding to current state.
//------------------------------------------------------------------------------
VectorXd SinsMukfOld::h_func_gps(NavStateOld x, Vector3d l_bS_b, Vector3d w_ib_b)
{
